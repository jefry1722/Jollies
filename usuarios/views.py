...
def verAgrupaciones(request, id):
    ...
    if len(agrupaciones) is 0:
        return render(request, 'agrupaciones.html', {'swal_error_agrupaciones': True})
    if request.method == 'POST':
        ...
        if len(agrupacioneFiltradas) > 0:
            return render(request, 'agrupaciones.html', {'agrupaciones': agrupacioneFiltradas})
        return render(request, 'agrupaciones.html', {'agrupaciones': agrupaciones, 'swal_error_agrupacion': True})
    return render(request, 'agrupaciones.html', {'agrupaciones': agrupaciones})
...
def verGeneros(request):
    ...
    if request.method == 'POST':
        ...
        if len(generosFiltrados) > 0:
            return render(request, 'generos.html', {'generos': generosFiltrados})
        return render(request, 'generos.html', {'generos': generos, 'swal_error_generos': True})
...
def caracteristicasPorAgrupacion(request, id):
    try:
        ...
        return render(request, 'agrupaciones_agrupacion.html',
